...
- Updated feature guide to include PUUID account methods, website method, and status method
- Added examples for account lookup by PUUID, website news, and server status
