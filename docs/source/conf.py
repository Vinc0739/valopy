...
extensions = [
    ...
    'sphinx_rtd_dark_mode',      # Dark mode toggle for RTD theme
]
...
# Only show class docstring, not __init__ docstring
...
# Dark mode is now handled by sphinx_rtd_dark_mode extension
